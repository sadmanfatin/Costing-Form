...
//        febricVO.executeQuery();
       ...
       // AdfFacesContext.getCurrentInstance().addPartialTarget(panelTabbed);
      // AdfFacesContext.getCurrentInstance().addPartialTarget(trimsTABLE);
     //   AdfFacesContext.getCurrentInstance().addPartialTarget(othersTABLE);
...
//            System.out.println("........................prefix for trim= "+te);
    ...
    public void managementCal(int marchand) {
        ...
        //String costCalformat=df.format(costCal);
        //costCal= Double.parseDouble(costCalformat);
     //  costCal= MyMath.round(costCal);
        System.out.println("..........-----------------cost="+costCal);
        MnjLineV.getCurrentRow().setAttribute("Cost",costCal);
       AdfFacesContext.getCurrentInstance().addPartialTarget(cost);
...
//        System.out.println("..........-----------------profit="+profitt);
        ...
        washTotalVal = getSelectedDryTotal() + getSelectedWetTotal();
       febricTotal=FebricTotal();
       trimTotalVal= TrimTotal();
       otherVal= othertotal();
      ...
      //  finaceValue=  MyMath.round(finaceValue);
        ...
        MnjLineV.getCurrentRow().setAttribute("Finance",finaceValue);
        ...
        MnjLineV.getCurrentRow().setAttribute("FabricCost",MyMath.roundTo3(febricTotal));
        MnjLineV.getCurrentRow().setAttribute("TrimCost",MyMath.roundTo3(trimTotalVal));
        MnjLineV.getCurrentRow().setAttribute("WashCost",MyMath.roundTo3(washTotalVal)); 
        MnjLineV.getCurrentRow().setAttribute("Others",MyMath.roundTo3(otherVal));
        ...
        try{
            CM=Double.parseDouble((getCmMerchandiser().getValue().toString()));    
        }
        catch(Exception e){
            CM=0.00;
        }
...
//            cmValue=CM;
//            double value=0.0;
//            MnjLineV.getCurrentRow().setAttribute("CmManagement",value);
//            MnjLineV.getCurrentRow().setAttribute("CmMerchand",MyMath.round(cmValue));
//        }
//        else{
//            cmValue=finaceValue+costCal+profit;
//            MnjLineV.getCurrentRow().setAttribute("CmManagement",MyMath.round(cmValue));
//            MnjLineV.getCurrentRow().setAttribute("CmMerchand",MyMath.round(cmValue));
//        
//        }
        ...
        //String cmformat=df.format(cmValue);
       // cmValue=  Double.parseDouble(cmformat);
      // cmValue=MyMath.round(cmValue);
       ...
       // newCost= Double.parseDouble(costformat);
        ...
        MnjLineV.getCurrentRow().setAttribute("TotalCost",totalcost);
       ...
       // System.out.println("..........-----------------cmValue="+cmValue);
        ...
        if(fobWithSmsVal > fobWitcommVal){
            ...
            MnjLineV.getCurrentRow().setAttribute("FobWithComm",Double.parseDouble(format.format(fobWithSmsVal)));
                                
             MnjLineV.getCurrentRow().setAttribute("Difference",
                                 Double.parseDouble(format.format(fobWithSmsVal))- targetPrice);
        }else {
            
             MnjLineV.getCurrentRow().setAttribute("FobWithComm",
                                Double.parseDouble(format.format(fobWitcommVal)));
             MnjLineV.getCurrentRow().setAttribute("Difference",
                                Double.parseDouble(format.format(fobWitcommVal))- targetPrice);
        }
       MnjLineV.getCurrentRow().setAttribute("FobWithSmsSample",
                                 Double.parseDouble(format.format(fobWithSmsVal)));
        
        MnjLineV.getCurrentRow().setAttribute("FobWithComm",FOB);
        MnjLineV.getCurrentRow().setAttribute("Fob",Double.parseDouble(format.format(fobWitcommVal)));
    ...
    public double FebricTotal() {
        OperationBinding ob = executeOperation("Commit");
        ob.execute();
        ViewObject febricV=am.getFebricView1();  
       febricV.executeQuery();
    ...
    public double TrimTotal() {
        OperationBinding ob = executeOperation("Commit");
        ob.execute();
        ViewObject trimV=am.getTrimsView1();
      // am.getDBTransaction().commit();
       trimV.executeQuery();
        
        ViewObject linevo=am.getMnjMfgPrecostingLView1();
        RowSet child = (RowSet)linevo.getCurrentRow().getAttribute("TrimsView");
        Row[] r = child.getAllRowsInRange();
   ...
   public double othertotal() {
        OperationBinding ob = executeOperation("Commit");
        ob.execute();
        ViewObject otherV=am.getOtherView1();  
       // am.getDBTransaction().commit();
      otherV.executeQuery();
       ViewObject linevo=am.getMnjMfgPrecostingLView1();
       RowSet child = (RowSet)linevo.getCurrentRow().getAttribute("OtherView");
       Row[] r = child.getAllRowsInRange();
...
//        other.executeQuery();
    ...
    private void populateLineDetails(Row poprow) {
           ...
           linerow.setNewRowState(Row.STATUS_INITIALIZED);  
            ...
            // header.getCurrentRow().setAttribute("AgencyCommission",getPopulateValue(poprow,"AgencyCommission"));
            header.getCurrentRow().setAttribute("FabricFinance",getPopulateValue(poprow,"FabricFinance"));
            header.getCurrentRow().setAttribute("TrimFinance",getPopulateValue(poprow,"TrimFinance"));
...
//                           "'");
    ...
    private String checkMendatoryFields() {
        ...
        ViewObject headerVo = am.getMnjMfgPrecostingHView1();
            ...
            {
                message = "Fabric Finance , Wash Finance or Trim Finance or Item Purchase Type  can't be empty" ;
            }
